...
console.log(`il y a ${handle.length}journalistes`)
...
console.log(`Il y ${i} journalistes avec un numéro`);

i=0;

handle.forEach(function(element) {

  if(/aude/.test(element.toLowerCase())){
  i++;
  }
});

console.log(`Il y ${i} journalistes contenant "aude"`);
